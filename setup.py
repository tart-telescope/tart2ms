...
setup(name='tart2ms',
    ...
    install_requires=[
                    ...
                    'dask_ms<=0.2.12; python_version>="3.10" and python_version<"3.12"',
                    'dask<=2024.8.1; python_version>="3.10" and python_version<"3.12"',
                    'python-casacore<=3.5.0; python_version>="3.10" and python_version<"3.12"',
                    'numpy<=1.23.5; python_version>="3.10" and python_version<"3.12"',
                    'pandas<=2.0.3; python_version>="3.10" and python_version<"3.12"',
                    'scipy<=1.11.4; python_version>="3.10" and python_version<"3.12"',
                    'astropy<=5.3.4; python_version>="3.10" and python_version<"3.12"',
                    'tart',
                    'tart_tools',
                    'h5py',
                    'progress',
    ...
    tests_require=['nose'],
    extras_require={
        "predict": ['codex-africanus<=0.3.4; python_version<"3.11"',
                    'numba<=0.55.1; python_version<"3.11"',
